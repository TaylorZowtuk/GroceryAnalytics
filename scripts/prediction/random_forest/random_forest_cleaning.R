...
clean_data_for_random_forest <- function(baskets, baskets_with_multiple_cust) {
  # Fix baskets with two customer ids
  # Remove the row with customer id 999...9 with the baskets other customer id
  # Logical OR the Cols representing the basket contains a given dept
