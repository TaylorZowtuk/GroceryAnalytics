...
d_1_clean <- function(baskets, baskets_with_multiple_cust) {
  ...
  baskets[baskets$CU_GENDER=="\r", ]$CU_GENDER <- "U"
  baskets[baskets$CU_GENDER=="F\r", ]$CU_GENDER <- "F"
  baskets[baskets$CU_GENDER=="M\r", ]$CU_GENDER <- "M"
